                ...
                <nav class="main-nav">
                    <ul>
                        ...
                        <?php if (isLoggedIn()): ?>
                            ...
                            <?php else: ?>
                                <li><a href="/customer/cart.php">السلة</a></li>
                                <li><a href="/customer/orders.php">طلباتي</a></li>
                                <li><a href="/customer/profile.php">حسابي</a></li>
                            <?php endif; ?>
                            <li><a href="/logout.php">تسجيل الخروج</a></li>
                        <?php else: ?>
                            <li><a href="/login.php">تسجيل الدخول</a></li>
                            <li><a href="/signup.php">حساب جديد</a></li>
                        <?php endif; ?>
                    </ul>
                </nav>
